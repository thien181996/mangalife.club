                ...
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" action="{{ route('panel.storeCategory') }}" method="post" enctype="multipart/form-data">
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6">
                                <input id="category_name" name="category_name" type="text" class="form-control m-input" placeholder="Nhập tên thể loại" value="{{ $category->category_name }}">
                                @if(count($errors) > 0)
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6">
                                <input id="category_slug" name="category_slug" type="text" class="form-control m-input" placeholder="Nhập đường dẫn" value="{{ $category->category_slug }}" >
                                @if(count($errors) > 0)
                                    <span class="m--font-danger">
